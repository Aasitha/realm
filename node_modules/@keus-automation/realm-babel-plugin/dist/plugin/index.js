...
function getRealmTypeForTypeArgument(typeParameters, notPlainObject = false) {
...
function getRealmTypeForTSTypeReference(path, notPlainObject = false) {
...
function getRealmTypeForTSType(path, notPlainObject = false) {
...
function visitRealmClass(path) {
    ...
    if ((0, import_checking_1.isRealmClassEmbedded)(schemaStatics)) {
        path.insertAfter(core_1.types.exportNamedDeclaration(core_1.types.variableDeclaration("const", [
            core_1.types.variableDeclarator(core_1.types.identifier(className), schema)
        ])));
        path.remove();
    }
    else {
