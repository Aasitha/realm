...
// Modified by @realm/babel-plugin
class IKeusDeviceSchema_deviceSyncInfoSchema extends _realm.default.Object {
  static embedded = true;
  static schema = {
...
exports.IKeusDeviceSchema_deviceSyncInfoSchema = IKeusDeviceSchema_deviceSyncInfoSchema;
// Modified by @realm/babel-plugin
...
class Methods {
  ...
  static async cleanSmartConsoleGroupButtons(realm) {}
  static async cleanSmartConsoleSceneButtons(realm) {}
  static async cleanSmartConsoleDeviceButtons(realm) {}
  static async cleanSceneWizardSceneButtons(realm) {}
  static async cleanSceneWizardDeviceButtons(realm) {}
  static async cleanZigbeeCurtainWizardDeviceButtons(realm) {}
  static async cleanSceneSwitchButtons(realm) {}
  static async updateEmbeddedApplianceGroups(realm) {}
  ...
  static async updateDeviceName(realm) {}
