...
import { applianceStateCollectionMap,appliancePropertiesCollectionMap } from "./schemas/gm-models/gmappliances";
...
(async () => {
  ...
  let res:any=await getDevices(JSON.parse(JSON.stringify(gmgroups)))
